...
package body Home_Containers.Generic_Heap_Vectors is
   ...
   begin
      return Container.Data (Container.Data'First)'Address;
   end;
   ...
   procedure Allocate (C : in out Vector; Size : Count) is
      use Ada.Assertions;
   begin
      Assert (C.Data = null, "Trying to allocate memory before freeing existing memory.");
      C.Data := new Element_Array (1 .. Size);
   end;

   procedure Free (C : in out Vector) is
